    ...
    <form action="" method="POST">
        <div class="container container-sm box" style="margin-top: 5%;">
                ...
                <div class="input-group mb-2 mr-sm-2">
                    ...
                    <input type="text" name="Servicename" class="form-control" id="inlineFormInputGroupUsername2"  placeholder="Nome">
                    </div>
            </div>
            ...
            <div class="container container-sm box">
                ...
                <div class="input-group mb-2 mr-sm-2">
                    ...
                    <input type="time" name="time" class="form-control" id="inlineFormInputGroupUsername2">
                </div>
            </div>
